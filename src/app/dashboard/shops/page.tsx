...
export default async function ShopsPage({ searchParams }: { searchParams:Promise<{ error?:string }> }) {
  ...
  const [{ data: profile }, { data: header }, { data: collections }, { data: products }, { data: linkCollections }, { data: links }] = await Promise.all([
